  ...
  this.innerHTML = /* html */
   ...
   <div class="marco-lectura">
     <ul>
       ...
       <li>
         <p>
          Cuando se cuente con suficiente dinero para pagar un equipo de
          trabajo muy capacitado, un hardware más caro y una forma de trabajo
          complicada.
         </p>
       </li>
     </ul>
...
customElements.define("h-2-uso-nativas", H2UsoNativas);