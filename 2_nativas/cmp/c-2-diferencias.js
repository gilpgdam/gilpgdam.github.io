   ...
   <div class="marco-lectura">
     <table class="borde">
       ...
       <tbody>
         <tr>
           <td>
            1 código por plataforma. (Posiblemente en distintos lenguajes.)
           </td>
           <td>
             1 código único para todas las plataformas.
           </td>
         </tr>
       </tbody>
     </table>
...
customElements.define("c-2-diferencias", C2Diferencias);