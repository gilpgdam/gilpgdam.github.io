...
export class E23AndroidManifest extends Diapositiva {
 /** @override */
 connectedCallback() {
  ...
  this.innerHTML = /* html */
   ...
   <div><span style="color: #800000;">&lt;manifest</span> <span
      style="color: #ff0000;">xmlns:android</span>=<span
   ...
   <div>&nbsp; <span style="color: #ff0000;">android:allowBackup</span>=<span
   ...
   <div>&nbsp; <span style="color: #ff0000;">android:supportsRtl</span>=<span
      style="color: #0000ff;">"true"</span></div>
   ...
   <div>&nbsp; &nbsp; <span
      style="color: #ff0000;">android:exported</span>=<span
...
customElements.define("e23-android-manifest", E23AndroidManifest);